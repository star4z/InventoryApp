 ...
 * [Builder.setRequestedFps] to specify a frame rate that works well with
...
private constructor() {
    ...
    (context: Context?, private val mDetector: Detector<*>?) {
        ...
        init {
            ...
            requireNotNull(mDetector) { "No detector supplied." }
     ...
     */
    private class SizePair(previewSize: Camera.Size,
    ...
    private fun createPreviewBuffer(previewSize: Size): ByteArray {
        ...
        check(!(!buffer.hasArray() || buffer.array() != byteArray)) { // I don't think that this will ever happen.  But if it does, then we wouldn't be
